...
echo "<script type='text/javascript'>
    ...
    <section>
        ...
        <div class="container" id="about-us" style="background-color: #fff;">
            <div class="row">
                <div class="col-7">
        ...
        <div class="container" style="background-color: #fff;">
            <div class="row">
                <?php include("cardIndex.php");?>
            </div>
        </div>

        <h2 class="latest-news">Estadísticas</h2>
        <div class="container" style="background-color: #fff;">
            <?php include_once("graficoLinea.php");?>
        </div>

        <h3 class="latest-news">Cantidad de denuncias por provincia</h3>
        <div class="container" style="background-color: #fff;">
            <?php include("graficoGeografico.php");?>
        </div>
