    ...
    <table class="table table-hover table_id">
        ...
        <tbody>
          <tr>
            ...
            <td>$descripcion</td>
            <td>$i[nombre]</td>
            <td><a href='aEliminar.php?aBorrar=$i[idEventos] ' title='Eliminar' <i class='fa-solid fa-trash msgTool' style='color: #ff2b05;'></i></a></td> 
            </tr>";
      ...
      <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
          ...
          <tbody>
            <tr>
              ...
              <td>$descripcion</td>
              <td>$j[nombre]</td>
              <td><a href='aEliminar.php?activar=$j[idEventos] ' title='Activar' <i class='fa-solid fa-house-medical-circle-check msgTool' style='color: #19e67c;'></i></a></td> 
              </tr>";
